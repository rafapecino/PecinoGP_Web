          ...
          <div className="space-y-8 text-white/80 leading-relaxed">
            <section>
              ...
              <p>
                ...
                instalan en el navegador del usuario para almacenar y recuperar
                información sobre la navegación. Permiten reconocer al usuario,
                recordar sus preferencias y ofrecer una experiencia más
                adecuada.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4 mt-4">
                ...
                <div className="p-5 rounded-2xl bg-white/5 border border-white/10">
                  ...
                  <p className="text-white/70">
                    Nos permiten medir el uso del sitio (páginas visitadas,
                    errores, dispositivos) para mejorar el servicio. Solo se
                    activan tras tu consentimiento.
                  </p>
                  <p className="text-white/50 text-sm mt-2">
                    De terceros · Proveedor: Google · Duración: hasta 24 meses ·
                ...
                <div className="p-5 rounded-2xl bg-white/5 border border-white/10">
                  ...
                  <p className="text-white/70">
                    Algunos vídeos del canal se muestran incrustados. Para
                    proteger tu privacidad, el reproductor{" "}
                    <strong className="text-white">
                      no se carga automáticamente
                    </strong>
                    : primero ves una miniatura y solo al pulsar el botón de
                    reproducir se carga el vídeo desde{" "}
                    <strong className="text-white">youtube-nocookie.com</strong>
                    , momento en el que Google puede instalar cookies propias en
                    tu navegador.
                  </p>
                  <p className="text-white/50 text-sm mt-2">
                    De terceros · Proveedor: Google (YouTube) · Se activa solo
                    al reproducir · Finalidad: reproducción de vídeo.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <p className="mt-3">
                ...
                eliminar cookies desde sus preferencias:
              </p>
            ...
            <section>
              ...
              <p>
                MPC Network SL puede modificar esta política para adaptarla a
                cambios normativos o técnicos. Te recomendamos revisarla
                periódicamente. Si los cambios son sustanciales, te volveremos a
