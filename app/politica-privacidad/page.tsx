      ...
      <main className="pt-32 md:pt-40 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8 text-white/80 leading-relaxed">
            <section>
              <p>
                En MPC Network SL nos comprometemos con la protección de los
                datos personales de los usuarios del sitio web pecinogp.es,
            ...
            <section>
              ...
              <ul className="space-y-2 pl-6 list-disc marker:text-red-500">
                <li>
                  Atender consultas o solicitudes enviadas a través de los
                  formularios o por email.
                </li>
                <li>
                  Gestionar la participación en encuestas (polls) y preguntas
                  (Q&amp;A) del sitio.
                </li>
                <li>
                  Elaborar estadísticas anónimas de uso del sitio mediante
              ...
              <p className="mt-3">
                ...
                perfiles con efectos jurídicos sobre los usuarios.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="space-y-2 pl-6 list-disc marker:text-red-500">
                <li>
                  <strong className="text-white">Consentimiento expreso</strong>{" "}
                  del interesado (art. 6.1.a RGPD) para cookies no necesarias,
                  formularios y suscripciones.
                </li>
                <li>
                  <strong className="text-white">Interés legítimo</strong> (art.
                  6.1.f RGPD) para mantener la seguridad y el funcionamiento
                  técnico del sitio.
                </li>
              </ul>
              <p className="mt-3">
                El consentimiento puede revocarse en cualquier momento desde el
                panel de cookies o escribiendo a rafapecino@gmail.com, sin que
            ...
            <section>
              ...
              <p>
                ...
                prestar los servicios del sitio utilizamos los siguientes
                proveedores (encargados del tratamiento), todos ellos con
                garantías equivalentes a las del RGPD:
              </p>
              <ul className="space-y-2 pl-6 list-disc marker:text-red-500">
                <li>
                ...
                <li>
                  <strong className="text-white">
                    Dorna Sports / motogp.com
                  </strong>{" "}
                  — datos públicos de clasificación deportiva.
                </li>
              </ul>
              <p className="mt-3">
                Algunos proveedores (como Google) pueden realizar transferencias
                internacionales a países fuera del EEE, amparadas en cláusulas
            ...
            <section>
              ...
              <p>
                ...
                determinar las posibles responsabilidades derivadas. Los datos
                de las encuestas (votos por IP) se conservan únicamente para
                evitar votos duplicados durante la vida de la encuesta.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Como interesado, puedes ejercer en cualquier momento los
                siguientes derechos enviando una solicitud a{" "}
                <strong className="text-white">rafapecino@gmail.com</strong>{" "}
                indicando el derecho que deseas ejercer y adjuntando copia de tu
                DNI o documento equivalente:
              </p>
              <ul className="space-y-2 pl-6 list-disc marker:text-red-500">
                <li>
                  <strong className="text-white">Acceso</strong> — saber qué
                ...
                <li>
                  <strong className="text-white">Supresión</strong> ("derecho al
                  olvido") — eliminar los datos cuando no sean necesarios.
                </li>
                <li>
                  <strong className="text-white">Oposición</strong> — oponerte a
                  tratamientos basados en interés legítimo.
                </li>
                <li>
                  <strong className="text-white">Limitación</strong> del
                  tratamiento.
                </li>
                <li>
            ...
            <section>
              ...
              <p>
                MPC Network SL aplica medidas técnicas y organizativas
                apropiadas para garantizar la seguridad de los datos personales
                y evitar su alteración, pérdida, tratamiento o acceso no
                autorizado. El sitio funciona íntegramente bajo conexión cifrada
                HTTPS (SSL/TLS).
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                MPC Network SL se reserva el derecho de modificar la presente
                política para adaptarla a novedades legislativas o
                jurisprudenciales. Cualquier cambio se publicará en esta página
                con su correspondiente fecha de actualización.
              </p>
            </section>
